...
# Add these functions to your database.py file
    ...
    #     """
    #     Save batch user availability data to database
    #
    #     Args:
    ...
    #             print(f"Checking if Record Exists...")
    #             cursor.execute(
    #                 '''SELECT avail_id FROM user_avail
    #                 WHERE user_id = %s AND event_id = %s AND date = %s
    #                 AND start_time = %s AND end_time = %s''',
    #                 (user_id, event_id, item['date'], item['startTime'], item['endTime'])
    #             )
    ...
    #                     WHERE user_id = %s AND event_id = %s AND date = %s
    #                     AND start_time = %s AND end_time = %s''',
    #                     (item['availability'], user_id, event_id, item['date'],
